    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LumoCash") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About LumoCash"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  lumocash-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the LumoCash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an lumocashtive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
These denominations are 0.01 LUMO, 0.1 LUMO, 1 LUMO and 10 LUMO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://lumocashcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://lumocashcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QString helpMessageGfx = ":/images/" + GUIUtil::getThemeName() + "/logo-vertical";
    QPixmap pixmap = QPixmap(helpMessageGfx);
    ui->aboutLogo->setPixmap(pixmap);
    ui->aboutLogo->setContentsMargins(25,45,0,0);
}
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LumoCash is shutting down...") + "<br /><br />" +
