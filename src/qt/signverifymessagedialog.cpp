...
#else
    ui->signMessageButton_SM->setIcon(QIcon(":/icons/" + theme + "/signature-white"));
    ui->clearButton_SM->setIcon(QIcon(":/icons/" + theme + "/remove"));
    ui->verifyMessageButton_VM->setIcon(QIcon(":/icons/" + theme + "/question-white"));
    ui->clearButton_VM->setIcon(QIcon(":/icons/" + theme + "/remove"));
#endif

    // These icons are needed on Mac also
    ui->addressBookButton_SM->setIcon(QIcon(":/icons/" + theme + "/address-book"));
    ui->pasteButton_SM->setIcon(QIcon(":/icons/" + theme + "/paste"));
    ui->copySignatureButton_SM->setIcon(QIcon(":/icons/" + theme + "/copy"));   
