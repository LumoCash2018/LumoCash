    ...
    mapper(0)
{
    ...
    //ui->theme->addItem(QString("LUMO-light"), QVariant("light"));
    //ui->theme->addItem(QString("LUMO-blue"), QVariant("drkblue"));
    //ui->theme->addItem(QString("LUMO-Crownium"), QVariant("crownium"));
    //ui->theme->addItem(QString("LUMO-traditional"), QVariant("trad"));
...
void OptionsDialog::setModel(OptionsModel *model)
{
    ...
    //connect(ui->theme, SIGNAL(valueChanged()), this, SLOT(showRestartWarning())); disabled
...
void OptionsDialog::setMapper()
{
    ...
    //mapper->addMapping(ui->theme, OptionsModel::Theme); disabled
