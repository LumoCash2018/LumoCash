    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText       = tr("LumoCash");
    QString versionText     = QString(tr("Version %1")).arg(QString::fromStdString(FormatFullVersion()));
    QString copyrightTextBtc   = QChar(0xA9)+QString(" 2009-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Bitcoin Core developers"));
    QString copyrightTextLumoCash   = QChar(0xA9)+QString(" 2018 ") + QString(tr("The LumoCash developers"));
    QString titleAddText    = networkStyle->getTitleAddText();
    // networkstyle.cpp can't (yet) read themes, so we do it here to get the correct Splash-screen
    QString splashScreenPath = ":/images/" + GUIUtil::getThemeName() + "/splash";
    if(GetBoolArg("-regtest", false))
        splashScreenPath = ":/images/" + GUIUtil::getThemeName() + "/splash-testnet";
    ...
    pixPaint.setPen(QColor(252,186,30));
    ...
    pixPaint.setFont(QFont(font, 27*fontFactor));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextLumoCash);
