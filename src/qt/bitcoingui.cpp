    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("LumoCash") + " - ";
#ifdef ENABLE_WALLET
    ...
    labelConnectionsIcon->setStyleSheet(".QPushButton { background-color: rgba(255, 255, 255, 0); margin-left:10px;}");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LumoCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and lumocash: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About LumoCash"), this);
    aboutAction->setStatusTip(tr("Show information about LumoCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutAction->setEnabled(false);
    aboutQtAction = new QAction(QIcon(":/icons/" + theme + "/about-qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/" + theme + "/settings"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for LumoCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LumoCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/question"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LumoCash addresses"));

    openInfoAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Information"), this);
    openInfoAction->setStatusTip(tr("Show diagnostic information"));
    openRPCConsoleAction = new QAction(QIcon(":/icons/" + theme + "/debug"), tr("&Debug console"), this);
    ...
    openRepairAction = new QAction(QIcon(":/icons/" + theme + "/settings"), tr("Wallet &Repair"), this);
    ...
    openAction->setStatusTip(tr("Open a lumocash: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/debug"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LumoCash help message to get a list with possible LumoCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("LumoCash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    switch(count)
    {
    case 0: icon = ":/icons/" + theme + "/forbidden"; break;
    case 1: case 2: case 3: icon = ":/icons/" + theme + "/connect-1"; break;
    case 4: case 5: case 6: icon = ":/icons/" + theme + "/connect-2"; break;
    case 7: case 8: case 9: icon = ":/icons/" + theme + "/connect-3"; break;
    default: icon = ":/icons/" + theme + "/connect-4"; break;
    }
    QIcon connectionItem = QIcon(icon).pixmap(STATUSBAR_ICONSIZE,STATUSBAR_ICONSIZE);
    labelConnectionsIcon->setIcon(connectionItem);
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LumoCash network", "", count));
}
...
void BitcoinGUI::setAdditionalDataSyncProgress(double nSyncProgress)
{
    ...
    if(masternodeSync.IsBlockchainSynced())
    {
        ...
        if(masternodeSync.IsSynced()) {
            ...
            labelBlocksIcon->setPixmap(QIcon(":/icons/" + theme + "/check-small-white").pixmap(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE));
        } else {
...
{
    QString strTitle = tr("LumoCash"); // default title
    ...
    menu(0)
{
    ...
    setStyleSheet(QString("QLabel { color : #fff; font-weight:bold; }").arg(platformStyle->SingleColor().name()));
}
