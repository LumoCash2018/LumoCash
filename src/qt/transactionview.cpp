    ...
    transactionView(0)
{
    ...
    watchOnlyWidget->setContentsMargins(0,0,0,0);
    watchOnlyWidget->setFixedWidth(24);
    watchOnlyWidget->addItem(QIcon(":/icons/" + theme + "/eye"),"", TransactionFilterProxy::WatchOnlyFilter_All);
    watchOnlyWidget->addItem(QIcon(":/icons/" + theme + "/eye-plus"), "", TransactionFilterProxy::WatchOnlyFilter_Yes);
    watchOnlyWidget->addItem(QIcon(":/icons/" + theme + "/eye-minus"), "", TransactionFilterProxy::WatchOnlyFilter_No);
