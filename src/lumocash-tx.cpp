...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("LumoCash lumocash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lumocash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lumocash transaction") + "\n" +
              "  lumocash-tx [options] -create [commands]   " + _("Create hex-encoded lumocash transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded lumocash transaction
