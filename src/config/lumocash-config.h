/* src/config/lumocash-config.h.  Generated from lumocash-config.h.in by configure.  */
/* src/config/lumocash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LUMO_CONFIG_H

#define LUMO_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The LumoCash developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "LumoCash"
...
#define PACKAGE_BUGREPORT "https://github.com/lumocashcoin/lumocashcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LumoCash"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LumoCash 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "lumocashcore"
