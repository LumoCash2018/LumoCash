 ...
 *
 *   // network
 *   CLumoCashNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.lumocashcoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLumoCashNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CLumoCashNetwork(UniValue objIn)
    {
...
// // can be under: LumoCashNetwork
// //   -- signature requirements : Key1(User)
// class CLumoCashNetworkVariable : public CGovernanceObject
// {
// private:
