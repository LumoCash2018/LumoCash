...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "LumoCashNetwork") type = LumoCashNetwork;
    if(strType == "LumoCashNetworkVariable") type = LumoCashNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == LumoCashNetwork) s = "LumoCashNetwork";
    if(type == LumoCashNetworkVariable) s = "LumoCashNetworkVariable";
