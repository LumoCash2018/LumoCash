...
{
    if(fLiteMode) return; // ignore all LumoCash related functionality
...
/*
    ...
    allow endless transaction that would bloat LumoCash and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("lumocash-privatesend");
