...
2. run lumocashd with -printalert or -sendalert like this:
   /path/to/lumocashd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://lumocashcoin.io";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/LumoCash:0.12.0.58/"));
