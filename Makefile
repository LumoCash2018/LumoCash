...
pkgdatadir = $(datadir)/lumocashcore
pkgincludedir = $(includedir)/lumocashcore
pkglibdir = $(libdir)/lumocashcore
pkglibexecdir = $(libexecdir)/lumocashcore
...
CONFIG_HEADER = $(top_builddir)/src/config/lumocash-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/lumocash-config.h.in \
...
ACLOCAL = ${SHELL} /home/pp/Desktop/lumocash/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/pp/Desktop/lumocash/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/pp/Desktop/lumocash/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/pp/Desktop/lumocash/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = lumocash-cli
BITCOIN_DAEMON_NAME = lumocashd
BITCOIN_GUI_NAME = lumocash-qt
BITCOIN_TX_NAME = lumocash-tx
...
COPYRIGHT_HOLDERS_FINAL = The LumoCash developers
COPYRIGHT_HOLDERS_SUBSTITUTION = LumoCash
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/pp/Desktop/lumocash/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = lumocashcore
PACKAGE_BUGREPORT = https://github.com/lumocashcoin/lumocashcoin/issues
PACKAGE_NAME = LumoCash
PACKAGE_STRING = LumoCash 1.0.1
PACKAGE_TARNAME = lumocashcore
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/pp/Desktop/lumocash
abs_srcdir = /home/pp/Desktop/lumocash
abs_top_builddir = /home/pp/Desktop/lumocash
abs_top_srcdir = /home/pp/Desktop/lumocash
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/pp/Desktop/lumocash/build-aux/install-sh
...
BITCOIND_BIN = $(top_builddir)/src/lumocashd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/lumocash-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/lumocash-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = LumoCash-Qt.app
OSX_DMG = LumoCash-Core.dmg
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_lumocash_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_lumocash_coverage.info test_lumocash.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/LumoCash-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/lumocash-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/lumocash-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/lumocash-config.h
$(top_srcdir)/src/config/lumocash-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/lumocash-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/LumoCash-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#	$(OSX_DEPLOY_SCRIPT) $(OSX_APP) -add-qt-tr $(OSX_QT_TRANSLATIONS) -translations-dir=$(QT_TRANSLATION_DIR) -dmg -fancy $(OSX_FANCY_PLIST) -verbose 2 -add-resources contrib/macdeploy/libs/libboost_system-mt.dylib
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/LumoCash-Qt

$(OSX_DMG): $(APP_DIST_EXTRAS)
	$(GENISOIMAGE) -no-cache-inodes -D -l -probe -V "LumoCash-Core" -no-pad -r -dir-mode 0755 -apple -o $@ dist
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/LumoCash-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_lumocash.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_lumocash -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_lumocash_filtered.info: test_lumocash.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_lumocash_filtered.info
#	$(MKDIR_P) qa/tmp
...
#rpc_test.info: test_lumocash_filtered.info
...
#test_lumocash_coverage.info: baseline_filtered_combined.info test_lumocash_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_lumocash_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_lumocash_filtered.info block_test_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_lumocash_filtered.info -a block_test_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_lumocash.coverage/.dirstamp:  test_lumocash_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_lumocash.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_lumocash.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
