...
This mechanism has been integrated into Bitcore-Node-LumoCash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/lumocashcoin/insight-api-lumocash#web-socket-api](https://github.com/lumocashcoin/insight-api-lumocash#web-socket-api) 
* API: [https://github.com/lumocashcoin/insight-api-lumocash#instantsend-transactions](https://github.com/lumocashcoin/insight-api-lumocash#instantsend-transactions) 
...
By default, the LumoCash daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LumoCash daemon:
